...
class login_page:
    def __init__(self, top=None):
        ...
        self.img = PhotoImage(file="./images/emp_login.png")
        self.label1.configure(image=self.img)

        self.entry1 = Entry(root)
        self.entry1.place(relx=0.362, rely=0.397, width=374, height=24)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=user)

        self.entry2 = Entry(root)
        self.entry2.place(relx=0.362, rely=0.525, width=374, height=24)
        ...
        self.button1.place(relx=0.370, rely=0.675, width=346, height=43)
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.031, rely=0.020, width=140, height=35)
        self.message.configure(font="-family {Poppins} -size 10")
        self.message.configure(foreground="#366ed8")
        ...
        self.clock.place(relx=0.9, rely=0.065, width=140, height=40)
        self.clock.configure(font="-family {Poppins Light} -size 12")
        self.clock.configure(foreground="#366ed8")
        self.clock.configure(background="#ffffff")
        # Displaying customer name
        self.entry1 = Entry(biller)
        self.entry1.place(relx=0.509, rely=0.20, width=200, height=24)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=cust_name)
        # Displaying customer number
        self.entry2 = Entry(biller)
        self.entry2.place(relx=0.796, rely=0.20, width=240, height=24)
        self.entry2.configure(font="-family {Poppins} -size 12")
        self.entry2.configure(relief="flat")
        self.entry2.configure(textvariable=cust_num)
        # For searching bill number
        self.entry3 = Entry(biller)
        self.entry3.place(relx=0.096, rely=0.20, width=240, height=24)
        ...
        self.button1.place(relx=0.017, rely=0.069, width=100, height=35)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.place(relx=0.300, rely=0.20, width=100, height=35)
        ...
        self.button3.place(relx=0.028, rely=0.860, width=120, height=40)
        ...
        self.button4.place(relx=0.124, rely=0.860, width=120, height=40)
        ...
        self.button5.place(relx=0.218, rely=0.860, width=120, height=40)
        ...
        self.button6.place(relx=0.313, rely=0.860, width=120, height=40)
        ...
        self.combo1.place(relx=0.027, rely=0.390, width=477, height=26)
        ...
        self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#366ed8")


        self.combo2 = ttk.Combobox(biller)
        self.combo2.place(relx=0.027, rely=0.465, width=477, height=26)
        ...
        self.combo3.place(relx=0.027, rely=0.541, width=477, height=26)
        ...
        self.entry4.place(relx=0.027, rely=0.619, width=477, height=26)
        ...
        self.Scrolledtext1.place(relx=0.450, rely=0.555, width=690, height=275)
    ...
    def get_subcat(self, Event):
        ...
        self.entry4.configure(state="disabled")
    # Displaying the available quantity
    def show_qty(self, Event):
        self.entry4.configure(state="normal")
        self.qty_label = Label(biller)
        self.qty_label.place(relx=0.024, rely=0.654, width=82, height=26)
        self.qty_label.configure(font="-family {Poppins} -size 10")
    ...
    def wel_bill(self):
        #displaying billnumber
        self.name_message = Text(biller)
        self.name_message.place(relx=0.516, rely=0.435, width=176, height=30)
        ...
        self.num_message.place(relx=0.900, rely=0.435, width=90, height=30)
        ...
        self.bill_message.place(relx=0.499, rely=0.460, width=176, height=26)
        ...
        self.bill_date_message.place(relx=0.872, rely=0.460, width=90, height=26)
