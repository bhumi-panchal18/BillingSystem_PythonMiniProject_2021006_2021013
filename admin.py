...
root.title("Billing System(ADMIN)")
...
class login_page:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("Billing System(ADMIN)")
        ...
        self.entry1.place(relx=0.375, rely=0.435, width=374, height=24)
        self.entry1.configure(font="-family {Poppins} -size 10")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=user)

        self.entry2 = Entry(root)
        self.entry2.place(relx=0.375, rely=0.544, width=374, height=24)
        ...
        self.button1.place(relx=0.375, rely=0.675, width=346, height=43)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8") #changes the colour of the button when pressed
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#366ed8")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admindash.png")
        self.label1.configure(image=self.img)

        self.button1 = Button(adm)
        self.button1.place(relx=0.020, rely=0.0615, width=100, height=38)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="white")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#366ed8")
        ...
        self.button2.place(relx=0.14, rely=0.588, width=146, height=63)
        ...
        self.button3.place(relx=0.418, rely=0.588, width=146, height=63)
        ...
        self.button4.place(relx=0.686, rely=0.588, width=146, height=63)
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.219, rely=0.275, width=100, height=37)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#366ed8")
        ...
        self.button2.place(relx=0.024, rely=0.092, width=92, height=36)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#366ed8")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#366ed8")
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
        ...
        self.button3.place(relx=0.036, rely=0.426, width=338, height=35)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#366ed8")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#ffffff")
        self.button3.configure(background="#366ed8")
        self.button3.configure(font="-family {Poppins SemiBold} -size 12")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.place(relx=0.036, rely=0.495, width=338, height=35)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#366ed8")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#366ed8")
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        ...
        self.button5.place(relx=0.036, rely=0.566, width=338, height=35)
        self.button5.configure(relief="flat")
        self.button5.configure(overrelief="flat")
        self.button5.configure(activebackground="#366ed8")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="#ffffff")
        self.button5.configure(background="#366ed8")
        ...
        self.button6.place(relx=0.115, rely=0.875, width=116, height=40)
        self.button6.configure(relief="flat")
        self.button6.configure(overrelief="flat")
        self.button6.configure(activebackground="#366ed8")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="#ffffff")
        self.button6.configure(background="#366ed8")
...
class add_product:
    def __init__(self, top=None):
        ...
        self.clock.place(relx=0.84, rely=0.095, width=102, height=36)
        self.clock.configure(font="-family {Poppins Light} -size 12")
        self.clock.configure(foreground="#000000")
        self.clock.configure(background="#ffffff")

        self.entry1 = Entry(p_add)
        self.entry1.place(relx=0.100, rely=0.350, width=996, height=30)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")

        self.entry2 = Entry(p_add)
        self.entry2.place(relx=0.100, rely=0.470, width=374, height=30)
        ...
        self.entry3.place(relx=0.100, rely=0.600, width=374, height=30)
        ...
        self.button1.place(relx=0.400, rely=0.836, width=100, height=44)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.place(relx=0.530, rely=0.836, width=100, height=44)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#366ed8")
        self.button2.configure(cursor="hand2")
...
class Update_Product:
    def __init__(self, top=None):
        ...
        self.entry1.place(relx=0.055, rely=0.350, width=996, height=30)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")

        self.entry2 = Entry(p_update)
        self.entry2.place(relx=0.055, rely=0.49, width=374, height=30)
        self.entry2.configure(font="-family {Poppins} -size 12")
        self.entry2.configure(relief="flat")
        ...
        self.entry3.place(relx=0.055, rely=0.63, width=374, height=30)
        self.entry3.configure(font="-family {Poppins} -size 12")
        self.entry3.configure(relief="flat")
        self.entry3.configure(validate="key", validatecommand=(self.r2, "%P"))

        self.entry4 = Entry(p_update)
        self.entry4.place(relx=0.055, rely=0.771, width=374, height=30)
        self.entry4.configure(font="-family {Poppins} -size 12")
        self.entry4.configure(relief="flat")
       

        self.entry6 = Entry(p_update)
        self.entry6.place(relx=0.5298, rely=0.49, width=374, height=30)
        self.entry6.configure(font="-family {Poppins} -size 12")
        self.entry6.configure(relief="flat")
       

        self.entry7 = Entry(p_update)
        self.entry7.place(relx=0.533, rely=0.630, width=374, height=30)
        self.entry7.configure(font="-family {Poppins} -size 12")
        self.entry7.configure(relief="flat")
       

        self.entry8 = Entry(p_update)
        self.entry8.place(relx=0.533, rely=0.762, width=374, height=30)
        self.entry8.configure(font="-family {Poppins} -size 12")
        self.entry8.configure(relief="flat")
...
class Employee:
    def __init__(self, top=None):
        ...
        self.entry1.place(relx=0.040, rely=0.276, width=240, height=28)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")

        self.button1 = Button(emp)
        self.button1.place(relx=0.215, rely=0.277, width=102, height=35)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.place(relx=0.028, rely=0.091, width=102, height=35)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#366ed8")
        self.button2.configure(cursor="hand2")
        ...
        self.button3.place(relx=0.04, rely=0.412, width=333, height=43)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#366ed8")
        self.button3.configure(cursor="hand2")
        ...
        self.button4.place(relx=0.04, rely=0.48,width=333, height=43)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#366ed8")
        self.button4.configure(cursor="hand2")
        ...
        self.button5.place(relx=0.04, rely=0.55, width=333, height=43)
        self.button5.configure(relief="flat")
        self.button5.configure(overrelief="flat")
        self.button5.configure(activebackground="#366ed8")
        self.button5.configure(cursor="hand2")
        ...
        self.button6.place(relx=0.118, rely=0.874,  width=110, height=35)
        self.button6.configure(relief="flat")
        self.button6.configure(overrelief="flat")
        self.button6.configure(activebackground="#366ed8")
        self.button6.configure(cursor="hand2")
...
class Update_Employee:
    def __init__(self, top=None):
        ...
        self.entry1.place(relx=0.056, rely=0.34, width=374, height=30)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")
        

        self.entry2 = Entry(e_update)
        self.entry2.place(relx=0.056, rely=0.48, width=374, height=30)
        self.entry2.configure(font="-family {Poppins} -size 12")
        self.entry2.configure(relief="flat")
        self.entry2.configure(validate="key", validatecommand=(self.r1, "%P"))

        self.entry3 = Entry(e_update)
        self.entry3.place(relx=0.056, rely=0.62, width=374, height=30)
        self.entry3.configure(font="-family {Poppins} -size 12")
        self.entry3.configure(relief="flat")
        self.entry3.configure(validate="key", validatecommand=(self.r1, "%P"))

        self.entry4 = Entry(e_update)
        self.entry4.place(relx=0.535, rely=0.34, width=374, height=30)
        self.entry4.configure(font="-family {Poppins} -size 12")
        self.entry4.configure(relief="flat")
        self.entry4.configure(validate="key", validatecommand=(self.r2, "%P"))

        self.entry5 = Entry(e_update)
        self.entry5.place(relx=0.535, rely=0.48, width=374, height=30)
        self.entry5.configure(font="-family {Poppins} -size 12")
        self.entry5.configure(relief="flat")

        self.entry6 = Entry(e_update)
        self.entry6.place(relx=0.535, rely=0.62, width=374, height=30)
        self.entry6.configure(font="-family {Poppins} -size 12")
        self.entry6.configure(relief="flat")
        self.entry6.configure(show="*")
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.046, rely=0.035, width=136, height=30)
        self.message.configure(font="-family {Poppins} -size 10")
        self.message.configure(foreground="#000000")
        self.message.configure(background="#ffffff")
        self.message.configure(text="""ADMIN""")
        ...
        self.entry1.place(relx=0.040, rely=0.278, width=240, height=28)
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")

        self.button1 = Button(invoice)
        self.button1.place(relx=0.215, rely=0.271, width=102, height=35)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#366ed8")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.place(relx=0.018, rely=0.085, width=102, height=35)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#366ed8")
        self.button2.configure(cursor="hand2")
        ...
        self.button3.place(relx=0.033, rely=0.412, width=340, height=50)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#366ed8")
        self.button3.configure(cursor="hand2")
        ...
        self.button4.place(relx=0.118, rely=0.874,  width=110, height=37)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#366ed8")
        self.button4.configure(cursor="hand2")
